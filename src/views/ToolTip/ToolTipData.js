...
export const ToolTipData = {
    init: new ToolTipItem(
        ...
        [
            <p>Lanes represent high level categories, such as teams, product lines, or strategic initiatives. Add a
                color and a description to your lane to communicate valuable details to stakeholders.</p>,
    ...
    laneAdded: new ToolTipItem(
        ...
        [
            <p>Bars are your specific initiative. Use them to represent your epics, projects, or tasks, and provide an
                at a glance view of priority, relationships and progress</p>,
